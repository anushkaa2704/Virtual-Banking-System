...
class Adashboard extends JFrame {
    Adashboard() {
        ...
        try (Connection con = DriverManager.getConnection(url, "root", "Apatil#2704")) {
        ...
        b1.addActionListener(
                a->
                {
                    //user ne min nay diya toh 0 se start
                    //max balance nay diya toh min balance ke upar ke sab entries

                    //table gayab karna
                    tableModel.setRowCount(0);
                    //read min and max values
                    double max,min;
                    String str1=t1.getText();//min
                    String str2=t2.getText();//max
                    if(str1.isEmpty())
                    {
                        min=0.0;
                    }
                    ...
                    //result set banake table bharna
